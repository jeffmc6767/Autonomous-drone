...
(library Library_1
	...
	(symbolDef "AP2127K-3_3TRG1" (originalName "AP2127K-3_3TRG1")
	...
	(compDef "AP2127K-3.3TRG1" (originalName "AP2127K-3.3TRG1") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		...
		(compPin "3" (pinName "__SHUTDOWN") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AP2127K-3_3TRG1"))
		...
		(attr "Datasheet Link" "https://www.diodes.com//assets/Datasheets/AP2127.pdf")
		(attr "Height" "1.45 mm")
	)

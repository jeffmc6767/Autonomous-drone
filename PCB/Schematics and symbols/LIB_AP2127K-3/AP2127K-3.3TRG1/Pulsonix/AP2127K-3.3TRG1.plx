...
//440451/2136016/2.50/5/2/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "AP2127K-3.3TRG1" (originalName "AP2127K-3.3TRG1")
	...
	(compDef "AP2127K-3.3TRG1" (originalName "AP2127K-3.3TRG1") (compHeader (numPins 5) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "3" (pinName "__SHUTDOWN") (partNum 1) (symPinNum 3) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "AP2127K-3.3TRG1"))
		...
		(attr "Manufacturer_Part_Number" "AP2127K-3.3TRG1")
		(attr "Mouser Part Number" "621-AP2127K-3.3TRG1")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/AP2127K-3.3TRG1?qs=x6A8l6qLYDCeAxisWuFs5g%3D%3D")
		(attr "Arrow Part Number" "AP2127K-3.3TRG1")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/ap2127k-3.3trg1/diodes-incorporated?utm_currency=USD&region=nac")
		(attr "Description" "DiodesZetex AP2127K-3.3TRG1, LDO Regulator, 3.3 V, +/-2% 5-Pin, SOT-23")
		(attr "<Hyperlink>" "https://www.diodes.com//assets/Datasheets/AP2127.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "AP2127K-3.3TRG1.stp")

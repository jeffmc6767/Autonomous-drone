...
(library Library_1
	...
	(compDef "bmp280" (originalName "bmp280") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "VDDIO_1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "GND_2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "VDDIO_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "https://datasheet.datasheetarchive.com/originals/distributors/DKDS-24/462913.pdf")
	)

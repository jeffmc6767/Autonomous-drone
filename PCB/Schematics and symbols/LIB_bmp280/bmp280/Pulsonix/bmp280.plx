...
//237787/2136016/2.50/8/0/Integrated Circuit
...
(library Library_1
	...
	(compDef "bmp280" (originalName "bmp280") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "VDDIO_1") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "7" (pinName "GND_2") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Power))
		(compPin "8" (pinName "VDDIO_2") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Power))
		...
		(attr "Mouser Part Number" "262-BMP280")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Bosch-Sensortec/BMP280?qs=QhAb4EtQfbUP9Z%252BCHM3Wyg%3D%3D")
		(attr "Arrow Part Number" "BMP280")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/bmp280/bosch?region=nac")
		(attr "Description" "Digital Pressure Sensor")
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/DKDS-24/462913.pdf")
		(attr "<STEP Filename>" "bmp280.stp")
